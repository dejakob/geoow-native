...
function DiscoverListItemBasic(props) {
    ...
    return (
        ...
        >
            ...
            >
                <Image
                    style={[getStyle('discoverListItem__image'), props.expanded ? { borderTopLeftRadius: undefined } : undefined]}
                    source={props.image}
                    resizeMode="cover"
                />
                <Image
                    style={[getStyle('discoverListItem__staticMap'), props.expanded ? { borderTopRightRadius: undefined } : undefined]}
